...
final class CreateUsersTable extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('id', 'string', ['limit' => 255])
              ->addColumn('email', 'string', ['limit' => 255])
              ->addColumn('name', 'string', ['limit' => 255])
              ->addColumn('picture', 'string', ['limit' => 500, 'null' => true])
              ->addColumn('verified_email', 'boolean', ['default' => false])
              ...
              ->addColumn('show_gone_items', 'boolean', ['default' => false])
              ->addColumn('email_notifications', 'boolean', ['default' => false])
              ->addColumn('new_listing_notifications', 'boolean', ['default' => false])
